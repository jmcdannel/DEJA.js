...
![Routes screen with track map](/screenshots/throttle_desktop_routes.png)
...
![Track map with selected route](/screenshots/throttle_desktop_routes2.png)
...
![Routes list view](/screenshots/throttle_desktop_routes.png)
...
If no routes are configured for the current layout, the list view shows an empty state. Routes are created and managed in the [Cloud app](/docs/cloud).
