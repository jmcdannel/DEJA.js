---
title: Onboarding
description: The onboarding wizard walks new users through account setup — choose a plan, enter payment for paid tiers, and register your first layout.
order: 10
---
...
Once you complete the wizard, you are ready to install the DEJA Server and start controlling trains. See the [Quick Start](/docs/quick-start) guide for the full walkthrough.
