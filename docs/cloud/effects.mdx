...
![Effects list view](/screenshots/cloud_desktop_effects.png)
...
| **Pin** | Light, LED, Street Light, Relay, Frog Juicer, Power, PIN | The output pin number on the connected device (Arduino, ESP32, or Pico W) |
...
![Sound file picker](/screenshots/cloud_desktop_add-effect.png)
...
![Effect form](/screenshots/cloud_desktop_add-effect2.png)
...
- [Turnouts Configuration](/docs/cloud/turnouts) -- Link effects to turnout actions.
- [Signals Configuration](/docs/cloud/signals) -- Configure signal heads, which are similar to multi-pin effects.
- [Layout Configuration](/docs/cloud/layout) -- Manage the devices that host your effects.
