...
After onboarding, users are taken to a **Setup Complete** page that confirms layout creation, displays their Layout ID, offers a quick-add form for their first locomotive, and provides server installation instructions. Layouts are automatically approved on creation -- there is no admin approval step.
