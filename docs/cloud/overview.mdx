...
![Cloud app dashboard](/screenshots/cloud_desktop_dashboard.png)
...
![Cloud app navigation sidebar](/screenshots/cloud_desktop_dashboard.png)
...
- [Devices](/docs/cloud/devices) -- Register and manage hardware controllers.
- [Connect](/docs/cloud/connect) -- Manage live connections to your hardware.
