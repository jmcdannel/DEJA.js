...
![Turnouts list view](/screenshots/cloud_desktop_turnouts.png)
...
![Turnout sorter dialog](/screenshots/cloud_desktop_turnouts.png)
...
![Turnout form](/screenshots/cloud_desktop_turnouts.png)
...
- [Routes Configuration](/docs/cloud/routes) -- Create automated sequences of turnout throws.
- [Layout Configuration](/docs/cloud/layout) -- Manage the devices that control your turnouts.
- [Effects Management](/docs/cloud/effects) -- Link effects to turnout actions.
