...
If you want to work with the full monorepo source code, you also need:
...
- [Installation](/docs/installation) -- Detailed setup for developers who want the full monorepo experience.
