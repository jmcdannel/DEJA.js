...
export default function MonitorPage() {
  const title = 'DEJA.js Monitor';
  const tagline = 'Deep diagnostic visibility. Built for technical operators and layout builders who need to see the data flowing across their network.';
  const features = defaultFeatures;
  const ctaLabel = 'Launch Monitor Web App';
  const ctaHref = '/docs/monitor';
