...
export default function TourPage() {
  const title = 'DEJA.js Tour & IO';
  const tagline = 'Automate and expand. Leverage structured presets and plug-and-play code to push your layout beyond basic throttle control.';
  const features = defaultFeatures;
  const ctaLabel = 'View Tour Docs';
  const ctaHref = '/docs/tour';
