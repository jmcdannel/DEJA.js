...
![Layout configuration page](/images/docs/cloud/layout-overview.png)
...
![Device details page](/images/docs/cloud/layout-device-details.png)
...
![Ports and modules cards](/images/docs/cloud/layout-ports-modules.png)
...
- [DCC-EX Console](/docs/apps/cloud/dcc-ex) -- Send commands to devices configured here.
- [Turnouts Configuration](/docs/apps/cloud/turnouts) -- Assign turnouts to the devices you register.
- [Effects Management](/docs/apps/cloud/effects) -- Assign effects to the devices you register.
