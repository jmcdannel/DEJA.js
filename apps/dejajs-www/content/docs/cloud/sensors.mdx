...
- [Effects Management](/docs/apps/cloud/effects) -- Create the effects that sensors trigger.
- [Signals Configuration](/docs/apps/cloud/signals) -- Use sensors to automate signal aspects.
- [Layout Configuration](/docs/apps/cloud/layout) -- Register the devices that host your sensors.
