...
|------|-------|-------------|
| [Home](/docs/apps/throttle/home) | `/` | Landing page with speedometer widgets for active throttles, login cards, and layout selection |
| [Throttle Control](/docs/apps/throttle/throttle) | `/throttle/:address` | Full single-locomotive control with speed, functions, consist, and emergency stop |
| [Throttle List](/docs/apps/throttle/throttle-list) | `/throttles` | Grid view of all active throttles for multi-train operation |
| [Conductor View](/docs/apps/throttle/conductor) | `/conductor` | Three-pane operator station layout with throttle list, active throttle, and turnouts |
| [Effects](/docs/apps/throttle/effects) | `/effects` | Sound effects, lights, and animation control |
| [Routes](/docs/apps/throttle/routes) | `/routes` | Interactive track maps and route execution |
| [Signals](/docs/apps/throttle/signals) | `/signals` | Signal monitoring and control |
| [Turnouts](/docs/apps/throttle/turnouts) | `/turnouts` | Track switch throw/close controls |
