...
![Throttle home screen with active throttles](/images/docs/throttle/home-screen.png)
...
**Clicking a speedometer** navigates you directly to the full [Throttle Control](/docs/apps/throttle/throttle) screen for that locomotive.

![Speedometer widget closeup](/images/docs/throttle/home-speedometer.png)
