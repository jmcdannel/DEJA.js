...
![Conductor view three-pane layout](/images/docs/throttle/conductor-view.png)
...
The left pane displays the same **ThrottleList** component used on the standalone [Throttle List](/docs/apps/throttle/throttle-list) page. All active throttles appear as tiles with speed displays, locomotive names, avatars, and horizontal button controls.
...
The right pane embeds the **TurnoutList** component from `@repo/ui`, showing all turnouts configured for the current layout. Each turnout displays its name and a throw/close toggle. See [Turnouts](/docs/apps/throttle/turnouts) for details on turnout controls.
...
For quick single-train operation on a phone, the standard [Throttle Control](/docs/apps/throttle/throttle) or [Throttle List](/docs/apps/throttle/throttle-list) views are better suited to the smaller screen.
