...
The Effects screen (`/effects`) lets you trigger and control layout effects including sound playback, LED lighting, street lights, relays, power switches, and multi-step macros. Effects are configured in the [Cloud app](/docs/apps/cloud) and controlled here in the Throttle app during operating sessions.

![Effects list with cards](/images/docs/throttle/effects-list.png)
