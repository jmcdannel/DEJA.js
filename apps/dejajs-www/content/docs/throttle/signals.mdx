...
![Signals list with aspect indicators](/images/docs/throttle/signals-list.png)
...
Signals are configured in the [Cloud app](/docs/apps/cloud), where you assign pin numbers, select the target device, and optionally set tags and descriptions. The Throttle app is used for monitoring and control during operations.
