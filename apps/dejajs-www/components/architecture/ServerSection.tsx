    ...
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <AnimateIn direction="right">
          ...
          <p className="text-gray-400 leading-relaxed">Install it anywhere Node.js runs — your laptop, a Raspberry Pi, or a dedicated server. One command and your entire layout is online.</p>
        </AnimateIn>
      </div>
    </section>
  );
