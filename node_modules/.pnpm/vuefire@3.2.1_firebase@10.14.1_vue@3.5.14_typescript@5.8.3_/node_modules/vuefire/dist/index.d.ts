...
declare function useStorageFileUrl(storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>): {
    url: vue_demi.Ref<string | null | undefined, string | null | undefined>;
    refresh: () => Promise<string | null>;
    promise: vue_demi.ShallowRef<Promise<string | null>, Promise<string | null>>;
};
/**
...
declare function useStorageFileMetadata(storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>): {
    metadata: vue_demi.ShallowRef<FullMetadata | null | undefined, FullMetadata | null | undefined>;
    update: (newMetadata: SettableMetadata) => Promise<FullMetadata | null>;
    refresh: () => Promise<FullMetadata | null>;
    promise: vue_demi.ShallowRef<Promise<FullMetadata | null>, Promise<FullMetadata | null>>;
};
/**
...
declare function useStorageFile(storageRef: MaybeRefOrGetter<_Nullable<StorageReference>>): {
    url: vue_demi.Ref<string | null | undefined, string | null | undefined>;
    metadata: vue_demi.ShallowRef<FullMetadata | null | undefined, FullMetadata | null | undefined>;
    snapshot: vue_demi.ShallowRef<UploadTaskSnapshot | null | undefined, UploadTaskSnapshot | null | undefined>;
    uploadTask: vue_demi.ShallowRef<UploadTask | null | undefined, UploadTask | null | undefined>;
    uploadError: vue_demi.ShallowRef<StorageError | null | undefined, StorageError | null | undefined>;
